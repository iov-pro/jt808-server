...
//
//        DictionaryEntity systemInit = dictionaryMapper.findByLabelAndKey("系统标识", "init");
//
//        if (systemInit == null) {
//            // 测试车辆
...
//                if (dictionaryMapper.findByLabelAndKey(d.getDicLabel(), d.getDicKey()) == null) {
